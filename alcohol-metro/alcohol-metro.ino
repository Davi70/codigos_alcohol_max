...
void loop() {
  ...
  float porcentaje = (valor_alcohol / 1023.0) * 100; // Calcula el porcentaje correctamente
  ...
  display.fillRect(0, 16, 128, 16, BLACK); // Borra la línea anterior del porcentaje
  display.setCursor(0, 16);
  display.print("Porcentaje: ");
  display.print(porcentaje, 2); // Muestra el porcentaje en la pantalla
  display.print("%");
